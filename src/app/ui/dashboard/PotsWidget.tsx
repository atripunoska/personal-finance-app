    ...
    <Card className="mb-3">
      <CardContent>
        <div className="flex justify-between mb-3">
          <h2 className="text-xl text-grey-900 dark:text-foreground font-semibold ">Pots</h2>
          <Link
            href="/dashboard/pots"
          ...
          <div className="bg-beige-100 dark:bg-secondary p-3 rounded-2xl flex flex-col w-full  flex-1 items-center justify-center">
            <div className="flex items-center justify-center content-center gap-3">
              ...
              <div className="flex flex-col pl-3">
                <span className="text-gray-400 dark:text-muted-foreground mb-3">Total savings</span>
